  ...
  return (
    <div className="mb-8  w-full  h-full">
      ...
      <div className=" bg-[#F8F8F8] mx-6 my-6 py-4 rounded-md border border-slate-400">
        ...
        />
        <div className=" flex justify-between mx-4 bg-green-white">
          <div className="min-w-0 flex flex-col flex-1 transition-all duration-300 mx-4">
            <div>
              <CostGraphs />
            </div>
            <div
              className="my-2 text-center text-blue-900 bg-blue-200 h-16 border border-blue-800 
          ...
          <div
            className={`transition-all duration-300 overflow-hidden shrink-0
                ${sideFilterOpen ? "w-72" : "w-0"}`}
          >
            <SideFilter
              className={`${
                sideFilterOpen ? "opacity-100" : "opacity-0"
